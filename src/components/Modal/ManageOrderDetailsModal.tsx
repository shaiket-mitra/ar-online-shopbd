...
import { FiCheck, FiClock, FiTruck, FiX, FiUser, FiMail, FiPhone, FiMapPin, FiDollarSign, FiCalendar } from "react-icons/fi";
...
const ManageOrderDetailsModal = ({ closeModal, isOpen, orderData }: { closeModal: () => void; isOpen: boolean; orderData: OrderData }) => {
  const { 
    name, 
    image, 
    category, 
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="flex items-center justify-between gap-2 flex-col sm:flex-row">
                      <div className="flex items-center space-x-2">
                        <div className={`flex items-center space-x-2 px-3 py-2 rounded-lg border ${currentStatus.color}`}>
                          {currentStatus.icon}
...
export default ManageOrderDetailsModal;